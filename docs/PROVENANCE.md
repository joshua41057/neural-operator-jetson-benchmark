...
| Sp²GNO | `families/sp2gno/inference_runs/`, `families/sp2gno/results/` | August 2026 campaign |
...
| Excluded | Reason |
|---|---|
| `WNO_Sp2GNO_Benchmarks/_archive_unused/runs/sp2gno_*` | Sp²GNO campaign superseded when the graph-Laplacian eigenbasis cache was regenerated and the affected Darcy checkpoints were retrained (Table 7 footnote). The canonical Sp²GNO records are the August 2026 campaign above. |
