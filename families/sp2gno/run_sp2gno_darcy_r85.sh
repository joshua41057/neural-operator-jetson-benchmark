...
RUN_TAG="${RUN_TAG:-sp2gno_exact_precision_darcy_r85_$(date +%Y%m%d_%H%M%S)}"
...
# Darcy: 421 / r = resolution. r=5 -> 85 (matches round(linspace(0,420,85)) exactly, spacing 420/84=5).
run_case sp2gno_darcy_base_r85 darcy "${NEW}/sp2gno_darcy_base_r85.pth" 24 0 5 20
